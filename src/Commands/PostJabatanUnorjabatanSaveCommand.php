...
class PostJabatanUnorjabatanSaveCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-simpeg:post-jabatan-unorjabatan-save';
     ...
     * @var string
     */
    protected $description = 'Send POST request to /jabatan/unorjabatan/save endpoint';
