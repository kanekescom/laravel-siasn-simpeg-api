...
class TestCase extends Orchestra
{
    ...
    public function getEnvironmentSetUp($app)
    {
        ...
        $app['config']->set('siasn-api.params_test.post_kursus_save_query', env('SIASN_PARAMS_TEST_POST_KURSUS_SAVE_QUERY'));
        ...
        $app['config']->set('siasn-api.params_test.post_skp22_save_query', env('SIASN_PARAMS_TEST_POST_SKP22_SAVE_QUERY'));

        $app['config']->set('siasn-api.params_test.get_skp_id', env('SIASN_PARAMS_TEST_GET_SKP_ID'));
        $app['config']->set('siasn-api.params_test.post_skp2021_save_query', env('SIASN_PARAMS_TEST_POST_SKP2021_SAVE_QUERY'));
        ...
        $app['config']->set('siasn-api.params_test.post_upload_dok_sk_kp_query', env('SIASN_PARAMS_TEST_POST_UPLOAD_DOK_SK_KP_QUERY'));

        $app['config']->set('siasn-api.params_test.post_cpns_save_query', env('SIASN_PARAMS_TEST_POST_CPNS_QUERY'));

        $app['config']->set('siasn-api.params_test.post_data_utama_update_query', env('SIASN_PARAMS_TEST_POST_DATA_UTAMA_UPDATE_QUERY'));
        ...
        $app['config']->set('siasn-api.params_test.post_upload_dok_rw_query', env('SIASN_PARAMS_TEST_POST_UPLOAD_DOK_RW_QUERY'));
    }
}
